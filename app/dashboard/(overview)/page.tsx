...
export default async function Page() {
  const arevenue = fetchRevenue();
  const alatestInvoices = fetchLatestInvoices();
  const acardData = fetchCardData();

  const [revenue, latestInvoices, cardData] = await Promise.all([arevenue, alatestInvoices, acardData]);
